...
Call log:
  ...
  - waiting for locator('weather-title')
    ...
    at Object.verifyWeatherTitle (/home/runner/work/readytotest.github.io/readytotest.github.io/test-playwright/pages/weatherAlertPageObject.ts:10:49)
...
- text: "Place: 3 km NW of The Geysers, CA Magnitude: 0.89 Latitude: 38.7973327636719 Longitude: -122.783668518066 Depth: 3.19 km Time: 5/2/2025, 1:37:51 PM Pacific URL: 📍"
- link "View on map":
  - /url: https://earthquake.usgs.gov/earthquakes/eventpage/nc75175521/map
...
- text: "Repo Size: 133690KB Timestamp: 5/2/2025, 1:54:42 PM Pacific git commit -m: \"chore: update readme\""
- link "readytotest.github.io":
  - /url: https://github.com/readytotest/readytotest.github.io
- text: "Repo Size: 200333KB Timestamp: 5/2/2025, 1:53:50 PM Pacific git commit -m: \"docs: shorten wording\""
- link "test-playwright":
  - /url: https://github.com/readytotest/test-playwright
- text: "Repo Size: 828KB Timestamp: 5/2/2025, 1:26:25 PM Pacific git commit -m: \"chore: add eslint-disable-next-line playwright/no-wait-for-timeout\" ----- Source File:"
...
```ts
   ...
   8 |     // eslint-disable-next-line playwright/no-wait-for-timeout
   9 |     await page.waitForTimeout(10000);
> 10 |     await expect(page.locator("weather-title")).toHaveText(title, options);
     |                                                 ^ Error: Timed out 5000ms waiting for expect(locator).toHaveText(expected)
  11 |   };
  12 |
  13 |   return {
  14 |     verifyWeatherTitle,
  15 |   };
  16 | };
  17 |
```