...
Received string: "Let's connect!Send MessageUnable to send Feedback. This could be because of network issues, or because you are using an ad-blockerNameEmailMessage(required)Send Now!Cancel"
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for locator('#sentry-feedback')
    5 × locator resolved to <div id="sentry-feedback"></div>
      - unexpected value "Let's connect!Send MessageNameEmailMessage(required)Send Now!Cancel"
    4 × locator resolved to <div id="sentry-feedback"></div>
      - unexpected value "Let's connect!Send MessageUnable to send Feedback. This could be because of network issues, or because you are using an ad-blockerNameEmailMessage(required)Send Now!Cancel"
...
- link:
  - /url: /index.htm
- img "nevada flag"
- text: About ℹ️ Welcome to my personal homepage. It's like a peek into my garage workshop, where you get to see what I'm tinkering on and how I think about QA. And yep, I'm still maintaining this site. It's Alive and Kicking in 2025! Hop on for the ride, full of trial and error
- link ".":
...
- text: "Place: 4 km NW of Laytonville, CA Magnitude: 1.49 Latitude: 39.7150001525879 Longitude: -123.522163391113 Depth: 6.48 km Time: 4/18/2025, 12:59:41 PM Pacific URL: 📍"
- link "View on map":
...
- dialog:
  - heading "Send Message" [level=2]:
    ...
    - link "Powered by Sentry":
      ...
      - img
  - group:
    - text: Unable to send Feedback. This could be because of network issues, or because you are using an ad-blocker Name
    - textbox "Name": Mr. QA Tester
    - text: Email
    - textbox "Email": name@invalid-qa-email.org
    - text: Message (required)
    - textbox "Message (required)": This text was generated by Playwright!!! Angulus caecus antiquus defleo. Ars sol nesciunt acies torrens inflammatio. Desolo coniecto dolor esse voveo aeternus suus thesis crapula cuppedia. TestID:1745007695596 04-18-2025
    - button "Send Now!"
    - button "Cancel"
```
